    ...
    return (
      <div style={divStyle}>
        <form style={formStyle}>
          ...
          {input !== '' ? (
            <div style={divS}>
              <button value="X" className="fa fa-times" style={input2Style} onClick={this.clearText} tabIndex="-3" type="button" aria-label="boton" />
              <button className="fa fa-search" style={inputSearch} onClick={this.search} tabIndex="-2" type="button" aria-label="boton" />
            </div>
          )
            : <button className="fa fa-search hover" tabIndex="-2" type="button" aria-label="boton" /> }
        </form>
      </div>
    );
  }
